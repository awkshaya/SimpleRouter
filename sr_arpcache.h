...
//Jiexi
void handle_arpreq(struct sr_instance* sr, struct sr_arpreq* request); //specified in the spec of this file
void handle_arppacket(struct sr_instance* sr, char* interface, struct sr_arp_hdr* arpheader); //arp packet handler called in sr_handlepacket()
